...
class PythonClient(object):
    ...
    def add_person(self):
        ...
        person.homeAddress = input("Enter home address: ")
    ...
    def list_all(self):
        ...
        try:
            ...
            for person in response.people:
                if (home_address == person.homeAddress):
                    """
                    Client function to call the rpc for listPeople
                    """
                    flag = True
...
def print_person(person):
    ...
    print("  Home address:", person.homeAddress)
...
def get_user_choice():
    ...
    print("[5] Search by home address.")
    print("[q] Quit.")
